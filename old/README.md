...
Il faudra installer Pillow sur votre ordinateur avec `pip3 install Pillow`. C'est la seule dépendance nécessaire au bon fonctionnement.
...
Les fichiers images sont au format jpeg avec une résolution de 128x128, et les sons sont au format mp3 en stéréo à 128ko/s.
 ...
 - Pour extraire une playlist existante:
```
python3 main.py -e playlist.bin
```

Cela va créer toute une arborescence dans un répertoire `extract_DDMMYYYYHHMMSS` dans lequel vous pourrez librement déplacer, ajouter ou supprimer les histoires.

 - Quand toutes les modifications sont faites, il faut lancer cette commande pour construire la playlist:
```
python3 main.py -b extract_DDMMYYYYHHMMSS
```

Cela va créer un répertoire build__DDMMYYYYHHMMSS qui contient à la fois la playlist, les sons et les images. Il faut copier tout le contenu de ce dossier sur la carte SD de la Merlin.

## Exemples

```
% python3 main.py -e /home/user/merlin/playlist.bin 
Current playlist:
...
[SUCCESS] Playlist has been completely extracted to /home/user/merlin/output_08012025185038
[INFO] You can now add your own songs into this directory.
[INFO] Once done, you can build a new playlist using the following command:
[INFO] python3 merlin.py -b /home/user/merlin/output_08012025185038
```

J'ai ajouté une nouvelle catégorie d'histoires, je peux maintenant construire la nouvelle playlist:
```
python3 merlin.py -b /home/user/merlin/output_08012025185038
Root (id: 1, children: 6)
    |-- Histoires (id: 2, children: 6)
        ...
        |-- Les mini-mondes (id: 12, children: 40)
            |-- Cambodge (id: 37, files: 887431b3-3099-4560-bc68-e5f5b677b7f7)
            |-- Paris (id: 38, files: aeb9336e-99cb-4bea-bd88-e08fe7a3c9e6)
            |-- Auvergne (id: 39, files: 42fca202-cf8b-44bf-b371-b3656e751b4e)
            |-- Brésil (id: 40, files: 0e3aef2a-dcc6-45f7-8527-ad6d835ce500)
            |-- Grèce (id: 41, files: e99095b2-4faf-4516-af5a-515c1c76ab69)
            |-- Indonésie (id: 42, files: 820e0ec5-f143-4dbc-9ca5-159b52e27d7a)
            |-- Jordanie (id: 43, files: 7db8ef35-7118-4c3b-91b1-6997ff2e128e)
            |-- Suède (id: 44, files: 4e4101fa-438d-4bad-a564-74d92594ed7e)
            |-- La Réunion (id: 45, files: 7a3b7b2d-32a0-4d12-8640-7899db540cd8)
            |-- Portugal (id: 46, files: 7e460476-d777-4610-8d96-cf881bcdd0c8)
            |-- Italie (id: 47, files: c7ab4fe3-8405-4bbf-b11b-0877588c3cab)
            |-- Espagne (id: 48, files: aa05c877-5354-4775-894c-b0cd1c1675d6)
            |-- Tunisie (id: 49, files: 684a24a2-2267-4c9d-b261-a0c68a4943a8)
            |-- Ecosse (id: 50, files: 12109424-cc73-4679-9db0-7b605536add3)
            |-- Russie (id: 51, files: 234b6de5-9657-4030-a4d1-d8aae7196ff4)
            |-- Tanzanie (id: 52, files: d70f2d9d-a38d-4414-aa80-0edf36b99600)
            |-- Suisse (id: 53, files: 3a924c11-e147-418c-9563-b032eac7aa44)
            |-- Costa-Rica (id: 54, files: 704a6d03-d076-4b04-989b-6ec994c95fb7)
            |-- Tahiti (id: 55, files: 8ed231e5-ea75-4f9d-bf69-7cccda24c2a5)
            |-- Nouvelle-Zélande (id: 56, files: 13fe48e4-461c-43a2-bbec-5d3e5f27c3f7)
            |-- Angleterre (id: 57, files: 5a4639c2-9aa2-4df9-87ab-afa4d86584cd)
            |-- USA-Hollywood (id: 58, files: 1e9288fc-a0a2-4089-a793-8ba2c4afe5dc)
            |-- Egypte (id: 59, files: 0aa1292a-ba56-4bbf-bcb2-862115b54d70)
            |-- Maroc (id: 60, files: b040cfeb-1049-4022-a093-0497ccc56152)
            |-- USA-NY (id: 61, files: f0fd20d6-f4cf-4022-acae-51c13dff8f5a)
            |-- Vietnam (id: 62, files: 7b337c63-217d-4937-a040-acf94e47226a)
            |-- Cuba (id: 63, files: 92017ebd-2c05-476a-8f7b-d70892011531)
            |-- Côte d'Ivoire (id: 64, files: 3339dca0-ee40-446d-a311-df6561a043bf)
            |-- Bretagne (id: 65, files: 1f307943-d193-404e-9ac4-a17de26e707b)
            |-- Australie (id: 66, files: 331c4900-ef55-4386-b755-7e8f0827e829)
            |-- Mongolie (id: 67, files: 547c49fe-5fae-472f-9bb5-30bff663340e)
            |-- Islande (id: 68, files: 98f93017-b7c3-4615-9ffc-736ccd2b7de8)
            |-- Argentine (id: 69, files: c945013f-c0ea-4501-8aef-59e353f2550c)
            |-- Inde (id: 70, files: c3de0e73-5f6b-45c0-936d-cdba77fd665f)
            |-- Pays-Basque (id: 71, files: 7b3dfba1-b28b-4d58-a059-5f2bf3f8497c)
            |-- Pérou (id: 72, files: e40a3ed3-5f5c-4cd0-9062-0c99fd5183cb)
            |-- Mexique (id: 73, files: 63b1b03c-3391-4d0b-9a31-fee0ac8f5aa5)
            |-- Canada-Québec (id: 74, files: b6c29875-427a-4ac5-b713-844bafa4dd84)
            |-- Canada (id: 75, files: fa37aba9-eb3d-48e0-9063-8b79bdf7fd08)
            |-- Japon (id: 76, files: c3561c72-760e-41b0-b504-c7f66ab68223)

[SUCCESS] Playlist has been completely built into /home/user/merlin/output_08012025185038/build_20250109184032
[INFO] You can now copy the content of this directory to your Merlin box.
```
